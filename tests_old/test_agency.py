...
class AgencyTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        from tests_old.test_agents.CEO.CEO import CEO
        from tests_old.test_agents.TestAgent1.TestAgent1 import TestAgent1
        from tests_old.test_agents.TestAgent2.TestAgent2 import TestAgent2
